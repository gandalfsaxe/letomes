...
%%%%%%%%%%%%%%%% Custom additions to template from Gandalf and Oisin %%%%%%%%%%%%%%%%

%%%%%%%%%% Extra packages %%%%%%%%%%

\usepackage{subfig}   % needed for our way of doing sub-figures
\usepackage{caption}  % needed for our way of doing sub-figures
\usepackage{bm}       % for bold greek symbols
\usepackage{mathabx}  % astronomical symbols such as \Earth, \Sun, etc.
\usepackage{pdfpages} % for inserting PDF pages (typically used in appendix)
\usepackage{booktabs} % prettier tables 
\usepackage{csquotes} % context sensitive quotes.
\usepackage{enumitem} % alphabet instead of numbers in numerical sub-lists.

%%%%%%%%%% Extra commands %%%%%%%%%%

% Extra todonotes
\newcommand{\todoref}[1]{\todo[color=blue!40]{#1}}
\newcommand{\todoeasy}[1]{\todo[color=yellow!80]{#1}}
\newcommand{\pgh}[1]{\todo[color=green!40]{Poul: #1}}
\newcommand{\hhbs}[1]{\todo[color=green!40]{Hans Henrik: #1}}
\newcommand{\ow}[1]{\todo[color=green!40]{Ole: #1}}

% \vec command will be mathbf instead of arrows above.
\renewcommand{\vec}[1]{\mathbf{#1}}

% unit vector commands
\newcommand{\unitvector}[1]{\operatorname{}\!\bm{\hat{#1}}}

\newcommand{\xhat}{\unitvector{x}}
\newcommand{\yhat}{\unitvector{y}}
\newcommand{\zhat}{\unitvector{z}}

\newcommand{\rhat}{\unitvector{r}}
\newcommand{\thetahat}{\unitvector{\theta}}
\newcommand{\phihat}{\unitvector{\phi}}

% partial derivative command
\newcommand{\pd}[2]{\operatorname{}\frac{\partial #1}{\partial #2}}
% ordinary derivative command
\newcommand{\od}[2]{\operatorname{}\frac{\mathrm{d} #1}{\mathrm{d} #2}}

% blue text (used in some equations)
\newcommand{\blue}[1]{\textcolor{blue}{#1}}
\newcommand{\orange}[1]{\textcolor{orange}{#1}}
\newcommand{\red}[1]{\textcolor{red}{#1}}
\newcommand{\teal}[1]{\textcolor{teal}{#1}}

% For equation boxes with a little more space in them than \boxed
\usepackage{empheq}
