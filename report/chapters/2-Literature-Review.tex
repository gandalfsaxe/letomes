...
\begin{figure}
    ...
    \caption{Two possible Earth-Mars LETOs, demonstrating the expanded launch window from Earth, an advantage over the standard Hohmann transfer where Mars must be $44^\degree$ ahead of Earth (see \cref{fig:Hohmann-angle}) which happens every 26 months (Image: \cite{Topputo2014}).}
