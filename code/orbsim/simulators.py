...
def symplectic(x0, y0, p0_x, p0_y, max_iter=1000, target=target(celestials.MOON)):
    ...
    for i in range(max_iter):
        ...
        x_euler, y_euler, p_euler_x, p_euler_y = euler_step(h, x0, y0, p0_x, p0_y)
        x_verlet, y_verlet, p_verlet_x, p_verlet_y = verlet_step(h, x0, y0, p0_x, p0_y)
